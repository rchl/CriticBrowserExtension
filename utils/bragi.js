...
(function() {
  ...
  DocumentFragment.prototype.prependTemplate =
  Element.prototype.prependTemplate = function(tmpl) {
    return this.insertBefore(bragi.createTemplate(tmpl), this.firstChild);
  };
